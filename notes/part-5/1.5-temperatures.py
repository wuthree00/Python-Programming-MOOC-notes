...
## Sample output
# Please type in a temperature (F): -> input: '101'
# 101 degrees Fahrenheit equals 38.333333333333336 degrees Celsius

# Please type in a temperature (F): -> input: '21'
...
print(f"{temperature} degrees Fahrenheit equals {float((temperature-32)*(5/9))} degrees Celsius")
if temperature < 32:
