...
## Sample output
# Please type in the 1st word: -> input: 'car'
# Please type in the 2nd word: -> input: 'scooter'
# scooter comes alphabetically last.

## Sample output
# Please type in the 1st word: -> input: 'zorro'
# Please type in the 2nd word: -> input: 'batman'
# zorro comes alphabetically last.

## Sample output
# Please type in the 1st word: -> input: 'python'
# Please type in the 2nd word: -> input: 'python'
