...
## Sample output
# Please type in a temperature: -> input: '5.15'
...
## Sample output
# Please type in a temperature: -> input: '8.99'
...
## Sample output
# Please type in a number: -> input: '1.34'
# Integer part: 1
# Decimal part: 0.34
...
print(f"Integer part: {number-int(number)}")
